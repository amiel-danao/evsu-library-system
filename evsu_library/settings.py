"""
Django settings for evsu_library project.
...
ALLOWED_HOSTS = ["127.0.0.1", "evsu_evsu_library.pythonanywhere.com"]
...
INSTALLED_APPS = [
    ...
    'evsu_library.apps.MyAdminConfig',
    'django.contrib.auth',
...
ROOT_URLCONF = 'evsu_library.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries':{
                'system_extras': 'system.templatetags.system_extras',
...
WSGI_APPLICATION = 'evsu_library.wsgi.application'
...
EMAIL_PENALTY_SUBJECT = 'EVSU Reminder: Overdue Book Rental Penalty'